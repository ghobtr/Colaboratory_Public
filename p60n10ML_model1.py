...
modeljson=directory_path+'/model_p60n10ML_1.json'
...
for ticker in stock_list:
    ...
    def get_price():
        ...
        #df_stock = get_data(ticker, start_date=None, end_date='01/24/2021', index_as_date=False, interval="1d")
    ...
    fig2.write_html(ticker + 'p60n10ML_model1.html', auto_open=False)
